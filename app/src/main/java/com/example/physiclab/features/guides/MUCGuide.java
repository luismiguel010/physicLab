...
public class MUCGuide extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.exportGuide:
                exportGuide();
                Toast.makeText(MUCGuide.this, "Exportar guía.", Toast.LENGTH_LONG).show();
                return true;
        }
    ...
    public void exportGuide(){
        ...
        if (pdfFile.exists()) //Checking for the file is exist or not
        {
            ...
            Toast.makeText(MUCGuide.this, "The file not exists! ", Toast.LENGTH_SHORT).show();
